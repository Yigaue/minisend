...
class EmailsTest extends TestCase
{
     ...
     * @return void
     */
    public function itReturnsEmailsResource()
    {
    ...
    public function itReturnsAEmailResource()
    {
        $email = factory(Email::class)->create();
        $response = $this->getJson(
            "/api/v1/emails/$email->id", [
                'accept' => 'application/json',
                'content-type' => 'application/json',
            ]
        );
     ...
     * @return void
     */
    public function thatWeCanSeeTheComposeEmailPage()
    {
     ...
     * @return void
     */
    public function thatCanDeleteAnEmailResource()
    {
